...
export const Footer = () => {
  ...
  return (
    <section className="footer-section bg-[#F5F5F5] pt-16 pb-0 px-6 overflow-hidden flex flex-col items-center">
      ...
      {/* Massive Watermark — Now at the absolute bottom with high visibility */}
      <div className="footer-watermark w-full max-w-[1250px] mx-auto mt-24 mb-0 pointer-events-none select-none relative z-0" aria-hidden="true">
